...
#NOTE: TEMPORARY TEST FUNCTION !!!!!!!!!!!!!!!! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    def create_command_proto(command: str, target: str, command_param: int, source_sequence_number: int):
        ...
        if target_enum == ProtoCore.NODE_FCB:
            ...
            command_enum = utl.get_command_from_str(ProtoCmd.LrbCommand.Command, command)
            command_message.lrb_command.CopyFrom(ProtoCmd.LrbCommand(command_enum=command_enum, command_param=command_param))
